# This ViT is from the ViT [https://github.com/LTH14/ViT]
# Just image Transformer (ViT) for Pixel-space Diffusion

import torch
import torch.nn as nn
import math
import torch.nn.functional as F
from rhopsr.nn.model_zoo.vitsr.utils import VisionRotaryEmbeddingFast, get_2d_sincos_pos_embed, RMSNorm
...
class ViT(nn.Module):
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            ViTBlock(hidden_size, num_heads, mlp_ratio=mlp_ratio,
...
def ViT_B_16(**kwargs):
    return ViT(depth=12, hidden_size=768, num_heads=12,
...
def ViT_L_16(**kwargs):
    return ViT(depth=24, hidden_size=1024, num_heads=16,
...
def ViT_H_16(**kwargs):
    return ViT(depth=32, hidden_size=1280, num_heads=16,
