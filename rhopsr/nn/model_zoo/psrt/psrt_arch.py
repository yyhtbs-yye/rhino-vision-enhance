...
from rhopsr.nn.model_zoo.psrt.modules import SwinIRFM

from rhopsr.nn.model_zoo.psrt.patch_of import flow_warp_avg_patch

class PSRT(nn.Module):
    """PSRT-Recurrent network structure. Paper: Rethinking Alignment in Video Super-Resolution Transformers"""
